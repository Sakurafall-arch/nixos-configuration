-- Window animations from hyprland.lua
...
-- Springs
hl.curve("easy",           { type = "spring", mass = 1, stiffness = 80, dampening = 10 })
...
hl.animation({ leaf = "workspaces",    enabled = true,  speed = 1.94, spring = "easy",   style = "slidevert" })
